...
CONVEXHULL ConvexHullAlgorithm::computeConvexHull(std::vector<Vector3n> &uVertices){
...
void ConvexHullAlgorithm::readVertices(std::vector<Vector3n> &uVertices){
...
int ConvexHullAlgorithm::volumeSign(CONVEXHULLFACE f, CONVEXHULLVERTEX p){
...
void ConvexHullAlgorithm::loadComputedCHVertices(CONVEXHULL &uConvexHull){
    ...
    if (vertexHead) do {
        ...
        Vector3n computedVertex(vertexHead->v[0],vertexHead->v[1], vertexHead->v[2]);
...
void ConvexHullAlgorithm::loadComputedCHEdges(CONVEXHULL &uConvexHull){
    ...
    if (edgeHead) do {
        ...
        Point3n a(edgeHead->endPts[0]->v[0],edgeHead->endPts[0]->v[1],edgeHead->endPts[0]->v[2]);
        Point3n b(edgeHead->endPts[1]->v[0],edgeHead->endPts[1]->v[1],edgeHead->endPts[1]->v[2]);
...
void ConvexHullAlgorithm::loadComputedCHFaces(CONVEXHULL &uConvexHull){
    ...
    if (faceHead) do {
        ...
        Point3n a(faceHead->vertex[0]->v[0],faceHead->vertex[0]->v[1],faceHead->vertex[0]->v[2]);
        Point3n b(faceHead->vertex[1]->v[0],faceHead->vertex[1]->v[1],faceHead->vertex[1]->v[2]);
        Point3n c(faceHead->vertex[2]->v[0],faceHead->vertex[2]->v[1],faceHead->vertex[2]->v[2]);
